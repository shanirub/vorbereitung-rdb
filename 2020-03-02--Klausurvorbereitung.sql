...
-- liegt: 2-stellig 1:n --> ferienwohnungen die Adressen-ID als Fremdschlüssel hinzufügen
...
-- wohnt: 2-stellig 1:n --> personen die Adressen-ID als Fremdschlüssel hinzufügen
...
-- die Adrese der Wohnugn gibt es schon  
INSERT INTO ferienwohnungen (personenzahl, zimmerzahl, preis, fid, vid, aid) VALUES
  (5, 3, 68.00, 2, 1, 4);

-- Aufgabe 4d)
-- Tabelle ändern, ohne neu anzulegen
